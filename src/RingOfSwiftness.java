public class RingOfSwiftness implements Accessory {
    private String name;
    ...
    public RingOfSwiftness(String name, double hpBonus, double mpBonus, double speedBonus, double dmgBonus, double defBonus) {
        this.name = name;
